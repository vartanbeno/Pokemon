...
/**
*
* DiscardTDG: Discard Table Data Gateway.
* Points to the Discard table.
* Provides methods to insert, update, and delete cards that are in a player's discard pile.
*
...
public class DiscardTDG {
	...
	private static final String TABLE_NAME = "Discard";
